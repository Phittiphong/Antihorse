...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: 'bold', color: '#FF0303', marginBottom: 24, textAlign: 'center' },
  ...
  buttonText: { fontSize: 16, color: '#FF0303', fontWeight: 'bold' },
  graphSection: { backgroundColor: '#fff', borderRadius: 16, padding: 16, marginBottom: 24, elevation: 2 },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: '#FF0303', marginBottom: 12 },
